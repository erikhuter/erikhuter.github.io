...
Inspired by several known trace and extension theorems for Sobolev spaces, we plan to focus on constructing an extension operator for functions defined on subsets using a modification of the Whitney extension method. We believe that the results of the project will be useful for further development of the theory of function spaces of fractional order of smoothness on closed subsets of Euclidean spaces, and its applications.
